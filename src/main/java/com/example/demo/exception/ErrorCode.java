...
public enum ErrorCode {
    ...
    INVALID_CURRENT_PASSWORD(1007, "Mật khẩu hiện tại không chính xác", HttpStatus.BAD_REQUEST),
    USERNAME_INVALID(1008, "Người dùng phải có 3 ký tự trở lên",HttpStatus.BAD_REQUEST ),
    USER_NOT_EXISTED(1009, "Người dùng không tồn tại",HttpStatus.BAD_REQUEST),
